(() => {
  ...
  const renderPage59 = () => {
    ...
    const stack=(n,a,b)=>`<div class="book-page59-item"><span>${n}.</span><div><span>${a}</span><span>+ &nbsp;${b}</span><i></i><i></i></div></div>`;
    content.className='book-page book-page-59 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg065_sec001"><div class="book-page59-top"><p>Pia, kwa kutumia kadi ya namba unaweza kupanga namba hizo kama ifuatavyo:</p><table><thead><tr><th>Mamia<br>elfu</th><th>Makumi<br>elfu</th><th>Maelfu</th><th>Mamia</th><th>Makumi</th><th>Mamoja</th></tr></thead><tbody><tr><td>2 + 1</td><td>2 + 1</td><td>8 + 1</td><td>1 + 1</td><td>8 + 1</td><td>6</td></tr><tr><td>+ 3</td><td>7</td><td>4</td><td>8</td><td>9</td><td>9</td></tr><tr><td>6</td><td>10</td><td>13</td><td>10</td><td>18</td><td>15</td></tr><tr><td>6</td><td>0</td><td>3</td><td>0</td><td>8</td><td>5</td></tr></tbody></table><p>Kwa hiyo, jibu ni 603085.</p></div><div class="book-exercise-sheet book-page59-exercise"><h1 class="book-exercise-title">Zoezi la 4</h1><div class="book-page59-grid">${sums.map((s,i)=>stack(i+1,s[0],s[1])).join('')}</div></div></section>`;
  };

  const renderPage60 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const sums=[[100009,9991],[89725,9999],[80298,19712],[998456,154689],[6024872,3975127],[8925778,7897987],[1000009,999991],[199001,950999]];
    const stack=(n,a,b)=>`<div class="book-page60-item"><span>${n}.</span><div><span>${a}</span><span>+ &nbsp;${b}</span><i></i><i></i></div></div>`;
