(() => {
    ...
    <div class="book-number-tree" aria-label="Mchoro ${label}">
      ...
      <div class="book-tree-diagram">
        ...
        <svg class="book-tree-lines" viewBox="0 0 360 160" aria-hidden="true">
          <line x1="180" y1="18" x2="25" y2="181"/><line x1="180" y1="18" x2="130" y2="172"/>
          <line x1="180" y1="18" x2="230" y2="172"/><line x1="180" y1="18" x2="335" y2="181"/>
        </svg>
  ...
  const renderPage25 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg031_sec001"><div class="book-exercise-sheet book-page25-sheet"><table class="book-page25-cont"><tbody><tr><td></td><td>Elfu sita mia sita</td></tr><tr><td>7001</td><td></td></tr><tr><td></td><td>Elfu nne na themanini</td></tr><tr><td>9010</td><td></td></tr><tr><td></td><td>Elfu tisa mia saba</td></tr></tbody></table><div class="book-page25-question"><span>5.</span><div><p>(a) Weka alama ya vema <span class="book-page25-symbol">(✓)</span> iwapo ni sahihi au weka alama ya mkasi <span class="book-page25-symbol book-page25-x">(X)</span> iwapo sio sahihi katika jedwali lifuatalo. Mstari wa kwanza wa ulalo ni mfano.</p><table class="book-page25-check"><thead><tr><th>Namba kwa numerali</th><th>Namba kwa maneno</th><th>Alama</th></tr></thead><tbody>${checks.map(r=>`<tr><td>${r[0]}</td><td>${r[1]}</td><td>${r[2] ? `<span class="book-page25-symbol">${r[2]}</span>` : ''}</td></tr>`).join('')}</tbody></table><p class="book-page25-b">(b) &nbsp; Andika kwa usahihi namba ulizoweka alama <span class="book-page25-symbol book-page25-x">(X)</span> katika swali la 5(a).</p></div></div></div></section>`;
  };

  const renderPage26 = () => {
    const content=document.querySelector('#content');if(!content)return;
    content.className='book-page book-page-26 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg032_sec001"><div class="book-exercise-sheet book-page26-sheet"><div class="book-page26-question"><span>6.</span><div><p>Chunguza kielelezo namba 1 na 2, soma maelezo yake, kisha jibu maswali yanayofuata.</p><figure><img src="images/pg032_im001.jpg" alt="Jengo la Ngome Kongwe Zanzibar"><figcaption><span><strong>Kielelezo namba 1:</strong> Jengo la Ngome Kongwe lililopo Zanzibar</span><span>lilijengwa mwaka elfu moja mia sita tisini na tisa</span></figcaption></figure><figure><img src="images/pg032_im002.jpg" alt="Mlima Kilimanjaro"><figcaption><span><strong>Kielelezo namba 2:</strong> Mlima Kilimanjaro una urefu wa meta elfu tano</span><span>mia nane tisini na tano</span></figcaption></figure></div></div></div></section>`;
  };

  const renderPage27 = () => {
    const content=document.querySelector('#content');if(!content)return;
    content.className='book-page book-page-27 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg033_sec001"><div class="book-exercise-sheet book-page27-questions"><h1>Maswali</h1><p>(a) &nbsp; Andika kwa numerali namba ulizosoma.</p><p>(b) &nbsp; Andika thamani ya nafasi ya kila tarakimu ya namba ulizosoma.</p></div><div class="book-page27-intro"><h1>Kusoma na kuandika namba nzima zinazozidi 10000</h1><p>Idadi ya vitu inayozidi 10000 inaweza kuhesabiwa kwa urahisi kwa kutumia mafungu. Vilevile, ili kusoma na kuandika namba nzima zinazozidi elfu kumi kwa urahisi anza kubaini thamani ya nafasi ya kila tarakimu katika namba nzima husika.</p></div><div class="book-example-card book-page27-example"><div class="book-example-label">Mfano wa 1</div><p>Andika thamani ya nafasi ya kila tarakimu katika namba 61270, kisha andika namba hiyo kwa maneno.</p><div class="book-example-answer-heading">Jibu</div><div class="book-page27-answer"><p>0 ipo thamani ya nafasi ya mamoja,</p><p>7 ipo thamani ya nafasi ya makumi,</p><p>2 ipo thamani ya nafasi ya mamia,</p><p>1 ipo thamani ya nafasi ya maelfu,</p><p>6 ipo thamani ya nafasi ya makumi elfu.</p><p class="conclusion">Kwa hiyo, namba 61270 inaandikwa sitini na moja elfu mia mbili sabini.</p></div></div></section>`;
  };
  ...
  const renderPage29 = () => {
    ...
    content.querySelectorAll('.book-page29-last tbody td:last-child').forEach((cell) => {
      cell.innerHTML = `<span class="book-page29-place-value">${cell.textContent}</span>`;
    });
  };
  ...
  const renderPage44 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const labelStyle='font-size:20px!important;font-weight:900!important;line-height:1!important;-webkit-text-stroke:0.35px currentColor!important';
    const labels=`<div class="book-page44-labels"><span style="${labelStyle}">Mamia elfu</span><span style="${labelStyle}">Makumi elfu</span><span style="${labelStyle}">Maelfu</span><span style="${labelStyle}">Mamia</span><span style="${labelStyle}">Makumi</span><span style="${labelStyle}">Mamoja</span></div>`;
  ...
  const renderPage62 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg068_sec001"><div class="book-example-card book-page62-solution"><h2>Njia</h2><div><p><span>Idadi ya pundamilia:</span><b>78696</b></p><p><span>Idadi ya nyati:</span><b>+ &nbsp;2323</b></p><i aria-hidden="true"></i><p><span>Jumla ya wanyama:</span><b>81019</b></p><i aria-hidden="true"></i></div><p>Kwa hiyo, jumla ya wanyama ni 81,019.</p></div><div class="book-exercise-sheet book-page62-exercise"><h1 class="book-exercise-title">Zoezi la 5</h1><div class="book-page62-questions">${qs.map((q,i)=>`<div><span>${i+1}.</span><p>${q}</p></div>`).join('')}</div></div></section>`;
  };
  ...
  const renderPage64 = () => {
    ...
    content.querySelectorAll('.book-page64-example p, .book-page64-example li').forEach((node) => {
      node.innerHTML=node.innerHTML.replace(/ - /g, ' <span class="book-minus">−</span> ');
    });
  };
  ...
  const renderPage65 = () => {
    ...
    content.querySelectorAll('.book-page65-cont p, .book-page65-grid p > span:last-child, .book-page65-stack > span').forEach((node) => {
      node.innerHTML=node.innerHTML.replace(/−/g, '<span class="book-minus">−</span>');
    });
  };
  ...
  const renderPage73 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg079_sec001"><div class="book-example-card book-page73-example"><div class="book-example-label">Mfano wa 2</div><p>Waoka mikate huoka mikate 72,324 kila siku. Siku moja walioka mikate 45458 tu. Je, mikate mingapi haikuokwa siku hiyo?</p><h2>Njia</h2><div class="book-page73-solution"><div class="book-page73-solution-copy"><p>Idadi ya mikate inayo okwa kwa siku:</p><p>Mikate iliyookwa siku hiyo:</p><p>Mikate ambayo haikuokwa siku hiyo:</p></div><div class="book-vertical-operation book-page73-operation" aria-label="72324 toa 45458 ni 26866"><span>72324</span><span><b>−</b><span>45458</span></span><i aria-hidden="true"></i><span class="book-vertical-result">26866</span><i aria-hidden="true"></i></div></div><p>Kwa hiyo, mikate ambayo haikuokwa siku hiyo ni 26,866.</p></div><div class="book-exercise-sheet book-page73-exercise"><h1 class="book-exercise-title">Zoezi la 10</h1><div class="book-page73-questions">${qs.map((q,i)=>`<div><span>${i+1}.</span><p>${q}</p></div>`).join('')}</div></div></section>`;
  };
  ...
  const renderPage94 = () => {
    ...
    const line94h='<svg class="line-diagram line-diagram--h" viewBox="0 0 150 46"><line x1="16" y1="30" x2="134" y2="30" stroke="#161616" stroke-width="2"/><polygon points="8,30 18,25 18,35" fill="#161616"/><polygon points="142,30 132,25 132,35" fill="#161616"/><circle cx="38" cy="30" r="3.2" fill="#161616"/><circle cx="112" cy="30" r="3.2" fill="#161616"/><text x="38" y="17" text-anchor="middle" font-size="15">A</text><text x="112" y="17" text-anchor="middle" font-size="15">B</text></svg>';
    const line94v='<svg class="line-diagram line-diagram--v" viewBox="0 0 60 150"><line x1="25" y1="16" x2="25" y2="134" stroke="#161616" stroke-width="2"/><polygon points="25,8 20,18 30,18" fill="#161616"/><polygon points="25,142 20,132 30,132" fill="#161616"/><circle cx="25" cy="38" r="3.2" fill="#161616"/><circle cx="25" cy="112" r="3.2" fill="#161616"/><text x="38" y="42" font-size="15">C</text><text x="38" y="116" font-size="15">D</text></svg>';
    const answer94='<svg class="book-page94-answer" viewBox="0 0 520 80"><line x1="16" y1="20" x2="504" y2="20" stroke="#161616" stroke-width="2"/><polygon points="8,20 18,15 18,25" fill="#161616"/><polygon points="512,20 502,15 502,25" fill="#161616"/><line x1="110" y1="13" x2="110" y2="27" stroke="#161616" stroke-width="2"/><line x1="410" y1="13" x2="410" y2="27" stroke="#161616" stroke-width="2"/><text x="110" y="55" text-anchor="middle" font-size="17">A</text><text x="410" y="55" text-anchor="middle" font-size="17">B</text><line x1="130" y1="48" x2="222" y2="48" stroke="#e11d1d" stroke-width="2"/><polygon points="122,48 132,43 132,53" fill="#e11d1d"/><text x="260" y="53" text-anchor="middle" font-size="17">sm 10</text><line x1="298" y1="48" x2="390" y2="48" stroke="#e11d1d" stroke-width="2"/><polygon points="398,48 388,43 388,53" fill="#e11d1d"/></svg>';
    content.innerHTML=`<section data-section-id="pg100_sec001"><div class="book-page94-work"><h1><b>Kazi ya kufanya 1:</b> Kuonesha mahali kwa kutumia nukta</h1><ol><li>Tumia penseli kuweka nukta tano tofauti kwenye karatasi.</li><li>Andika majina ya nukta hizo kwa kutumia herufi kubwa.</li></ol></div><div class="book-page94-copy"><h1>Mstari</h1><p>Mstari huundwa na seti ya nukta zilizounganishwa pamoja na kuendelezwa pande mbili tofauti bila kuwa na mwisho. Mara nyingi mstari huoneshwa kwa kutumia mstari mnyoofu ambao huwekewa alama ya ↔ kila upande ili kuonesha kuwa hauna mwisho. Mstari huweza kuoneshwa kwa kutumia nukta mbili zilizopo kwenye huo mstari. Kielelezo kifuatacho ni mifano ya mistari minyoofu.</p><div class="book-page94-lines"><img src="images/pg100_mstari_diagrams_transparent.png" alt="Mistari minyoofu EF, AB na CD kama ilivyo kwenye kitabu"></div><p>Kwa hiyo, <span class="overarrow-both">EF</span> au <span class="overarrow-both">FE</span> ni kifupi cha mstari mnyoofu EF au FE. Vilevile, <span class="overarrow-both">AB</span> au <span class="overarrow-both">BA</span> na <span class="overarrow-both">CD</span> au <span class="overarrow-both">DC</span> ni mistari minyoofu.</p></div><div class="book-example-card book-page94-example"><div class="book-example-label">Mfano</div><p>Chora mstari, kisha weka nukta A na B zenye umbali wa sm 10 kutoka nukta A hadi nukta B.</p><h2>Jibu</h2><p>Mstari wenye nukta A na B zenye umbali wa sm10 kutoka nukta A hadi B.</p>${answer94}</div></section>`;
  };
  ...
  const renderPage96 = () => {
    ...
    const seg96ab='<svg class="line-diagram" viewBox="0 0 140 30"><line x1="15" y1="15" x2="125" y2="15" stroke="#161616" stroke-width="1.6"/><circle cx="15" cy="15" r="3" fill="#161616"/><circle cx="125" cy="15" r="3" fill="#161616"/><text x="15" y="9" text-anchor="middle" font-size="14">A</text><text x="125" y="9" text-anchor="middle" font-size="14">B</text></svg>';
    const seg96fe='<svg class="line-diagram" viewBox="0 0 140 90"><line x1="15" y1="75" x2="125" y2="15" stroke="#161616" stroke-width="1.6"/><circle cx="15" cy="75" r="3" fill="#161616"/><circle cx="125" cy="15" r="3" fill="#161616"/><text x="3" y="70" font-size="14">F</text><text x="129" y="12" font-size="14">E</text></svg>';
    const seg96cd='<svg class="line-diagram" viewBox="0 0 50 140"><line x1="25" y1="15" x2="25" y2="125" stroke="#161616" stroke-width="1.6"/><circle cx="25" cy="15" r="3" fill="#161616"/><circle cx="25" cy="125" r="3" fill="#161616"/><text x="34" y="19" font-size="14">C</text><text x="34" y="129" font-size="14">D</text></svg>';
    const mfano96a='<svg class="line-diagram" viewBox="0 0 140 90"><defs><marker id="mfano96a-arrow" markerWidth="10" markerHeight="10" refX="6" refY="5" orient="auto"><path d="M0,0 L10,5 L0,10 Z" fill="#161616"/></marker></defs><line x1="14" y1="76" x2="120" y2="16" stroke="#161616" stroke-width="1.6" marker-end="url(#mfano96a-arrow)"/><line x1="8" y1="70" x2="20" y2="82" stroke="#161616" stroke-width="1.6"/><line x1="76" y1="32" x2="88" y2="44" stroke="#161616" stroke-width="1.6"/><text x="2" y="92" font-size="14">A</text><text x="92" y="30" font-size="14">B</text></svg>';
    const mfano96b='<svg class="line-diagram" viewBox="0 0 140 90"><line x1="18" y1="78" x2="118" y2="18" stroke="#161616" stroke-width="1.6"/><line x1="12" y1="72" x2="24" y2="84" stroke="#161616" stroke-width="1.6"/><line x1="112" y1="12" x2="124" y2="24" stroke="#161616" stroke-width="1.6"/><text x="6" y="94" font-size="14">A</text><text x="112" y="10" font-size="14">B</text></svg>';
    const mfano96c='<svg class="line-diagram" viewBox="0 0 140 90"><defs><marker id="mfano96c-arrow" markerWidth="10" markerHeight="10" refX="6" refY="5" orient="auto"><path d="M0,0 L10,5 L0,10 Z" fill="#161616"/></marker></defs><line x1="18" y1="78" x2="118" y2="18" stroke="#161616" stroke-width="1.6" marker-end="url(#mfano96c-arrow)"/><line x1="12" y1="72" x2="24" y2="84" stroke="#161616" stroke-width="1.6"/><text x="2" y="94" font-size="14">L</text></svg>';
    content.innerHTML=`<section data-section-id="pg102_sec001"><div class="book-page96-work"><p><b>4.</b> Ni katika kazi ipi mistari ifuatayo imetengenezwa?</p><img class="book-page96-question4-diagrams" src="images/pg102_question4_diagrams_transparent.png" alt="Vipande vya mstari AB, FE na CD kama vilivyo kwenye kitabu"></div><div class="book-page96-copy"><h1>Sifa za kipande cha mstari</h1><p>Kipande cha mstari kina sifa zifuatazo:</p><p>(a) &nbsp; Kimenyooka<br>(b) &nbsp; Hakina unene<br>(c) &nbsp; Kina mwanzo katika nukta moja na mwisho kwenye nukta nyingine</p></div><div class="book-example-card book-page96-example"><div class="book-example-label">Mfano wa 1</div><p>Katika michoro ifuatayo bainisha mstari, kipande cha mstari au siyo mstari wala kipande cha mstari.</p><img class="book-page96-source-diagrams" src="images/pg102_mfano1_diagrams_transparent.png" alt="(a) Mstari AB, (b) kipande cha mstari AB, na (c) mchoro wa mstari L wenye mshale upande mmoja"><h2>Jibu</h2><p>(a) &nbsp; Ni mstari kwa sababu hauna nukta ya mwisho katika pande zote mbili.<br>(b) &nbsp; Ni kipande cha mstari kwa sababu kina pande mbili zenye nukta mwishoni.<br>(c) &nbsp; Si kipande cha mstari kwa sababu ina upande unaoanza na nukta na upande mmoja umewekewa mshale.</p></div></section>`;
  };

  const renderPage97 = () => {
    const content=document.querySelector('#content');if(!content)return;
    content.className='book-page book-page-97 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg103_sec001"><div class="book-example-card book-page97-example"><div class="book-example-label">Mfano wa 2</div><p>Andika jina la kila kipande cha mstari katika michoro ifuatayo:</p><div class="book-page97-three"><figure><figcaption>(a)</figcaption><img src="images/pg103_im001_transparent.png" alt="Kipande DQ"></figure><figure><figcaption>(b)</figcaption><img src="images/pg103_im002_transparent.png" alt="Kipande CD"></figure><figure><figcaption>(c)</figcaption><img src="images/pg103_im003_transparent.png" alt="Kipande AB"></figure></div><h2>Jibu</h2><p>(a) &nbsp; <span class="overline">DQ</span> &nbsp;&nbsp;&nbsp;&nbsp; (b) &nbsp; <span class="overline">CD</span> &nbsp;&nbsp;&nbsp;&nbsp; (c) &nbsp; <span class="overline">AB</span></p></div><div class="book-example-card book-page97-example second"><div class="book-example-label">Mfano wa 3</div><p>Andika vipande vyote vya mstari kutoka kwenye mchoro ufuatao:</p><div class="book-page97-abcd"><svg class="line-diagram" viewBox="0 0 480 40"><line x1="10" y1="14" x2="470" y2="14" stroke="#161616" stroke-width="1.8"/><circle cx="30" cy="14" r="4" fill="#161616"/><circle cx="163" cy="14" r="4" fill="#161616"/><circle cx="296" cy="14" r="4" fill="#161616"/><circle cx="429" cy="14" r="4" fill="#161616"/><circle cx="452" cy="14" r="4" fill="#161616"/><text x="30" y="34" text-anchor="middle" font-size="17">A</text><text x="163" y="34" text-anchor="middle" font-size="17">B</text><text x="296" y="34" text-anchor="middle" font-size="17">C</text><text x="429" y="34" text-anchor="middle" font-size="17">D</text></svg></div><h2>Jibu</h2><p><span class="overline">AB</span>, <span class="overline">AC</span>, <span class="overline">AD</span>, <span class="overline">BC</span>, <span class="overline">BD</span> na <span class="overline">CD</span></p></div><div class="book-example-card book-page97-example third"><div class="book-example-label">Mfano wa 4</div><p>Kuna vipande vingapi vya mstari katika mchoro ufuatao:</p><img src="images/pg103_im004_transparent.png" alt="Nyota yenye vipande vinane"><h2>Jibu</h2><p>Kuna vipande 8 vya mistari.</p></div></section>`;
  };

  const renderPage98 = () => {
    const content=document.querySelector('#content');if(!content)return;
    content.className='book-page book-page-98 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg104_sec001"><div class="book-exercise-sheet book-page98-exercise"><h1 class="book-exercise-title">Zoezi la 1</h1><div class="book-page98-q"><span>1.</span><div><p>Chora vipande vya mistari vyenye urefu ufuatao:</p><div class="book-page98-lengths"><span>(a) &nbsp; <span class="overline">PQ</span> = sm 4</span><span>(b) &nbsp; <span class="overline">CD</span> = sm 5</span><span>(c) &nbsp; <span class="overline">LM</span> = sm 6</span><span>(d) &nbsp; <span class="overline">JK</span> = sm 7</span><span>(e) &nbsp; <span class="overline">XY</span> = sm 8</span><span>(f) &nbsp; <span class="overline">EF</span> = sm 9</span><span>(g) &nbsp; <span class="overline">MN</span> = sm 10</span></div></div></div><div class="book-page98-q"><span>2.</span><p>Umbo mraba lina vipande vya mstari vingapi?</p></div><div class="book-page98-q"><span>3.</span><div><p>Kipi kati ya vifuatavyo kinawakilisha kipande cha mstari?</p><p>(a) &nbsp; <span class="overarrow-right">AB</span> &nbsp;&nbsp;&nbsp; (b) &nbsp; <span class="overarrow-both">AB</span> &nbsp;&nbsp;&nbsp; (c) &nbsp; <span class="overarrow-left">AB</span> &nbsp;&nbsp;&nbsp; (d) &nbsp; <span class="overline">AB</span></p></div></div><div class="book-page98-q"><span>4.</span><p>Ipi ni mifano ya vipande vya mstari katika maisha yetu ya kila siku?</p></div></div><div class="book-page98-copy"><h1>Mwale</h1><p>Mwale ni kipande cha mstari kinachoendelezwa upande mmoja bila kikomo. Upande unaoendelea bila kikomo huwekewa mshale. Mifano ya miale ni kama inavyooneshwa katika kielelezo kifuatacho:</p><img src="images/pg104_im001_transparent.png" alt="Miale AB, CD na EF"><p>Mwale huandikwa na alama ya mshale inayowakilisha mwale. Kwa mfano mwale AB huandikwa <span class="overarrow-right">AB</span> na mwale BA huandikwa <span class="overarrow-right">BA</span>.</p></div></section>`;
  };
  ...
  const renderPage100 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg106_sec001"><div class="book-example-card book-page100-example"><div class="book-example-label">Mfano wa 3</div><p>Andika majina ya miale yote katika mchoro ufuatao.</p><img src="images/pg106_im001_transparent.png" alt="Mchoro wa miale kutoka nukta A"><h2>Jibu</h2><p>Katika mchoro huu kuna miale ifuatayo:<br><span class="overarrow-right">AB</span>, <span class="overarrow-right">AC</span>, <span class="overarrow-right">BC</span>, <span class="overarrow-right">AD</span>, <span class="overarrow-right">AE</span>, <span class="overarrow-right">DE</span>, <span class="overarrow-right">AF</span>, <span class="overarrow-right">AG</span> na <span class="overarrow-right">FG</span>.</p></div><div class="book-page100-work"><h1><b>Kazi ya kufanya 4:</b> Kuchora mstari mnyoofu</h1><ol><li>Tumia rula kuchora miale miwili; mmoja ukielekea kushoto na mwingine kuelekea kulia.</li><li>Unganisha nukta za mwanzo za miale miwili katika hatua ya 1 ili kupata mstari ulionyooka.</li></ol></div><div class="book-exercise-sheet book-page100-exercise"><h1 class="book-exercise-title">Zoezi la 2</h1>${qs.map((q,i)=>`<div><span>${i+1}.</span><p>${q}</p></div>`).join('')}</div></section>`;
  };
  ...
  const renderPage101 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg107_sec001"><div class="book-exercise-sheet book-page101-exercise">${qs.map((q,i)=>`<div><span>${i+7}.</span><div><p>${q}</p>${i===1?`<div class="book-page101-line"><svg class="line-diagram" viewBox="0 0 320 40"><line x1="16" y1="16" x2="304" y2="16" stroke="#161616" stroke-width="1.8"/><polygon points="8,16 18,11 18,21" fill="#161616"/><polygon points="312,16 302,11 302,21" fill="#161616"/><circle cx="65" cy="16" r="4" fill="#161616"/><circle cx="160" cy="16" r="4" fill="#161616"/><circle cx="255" cy="16" r="4" fill="#161616"/><text x="65" y="36" text-anchor="middle" font-size="17">M</text><text x="160" y="36" text-anchor="middle" font-size="17">O</text><text x="255" y="36" text-anchor="middle" font-size="17">N</text></svg></div>`:''}</div></div>`).join('')}</div><div class="book-page101-copy"><h1>Kuunda maumbo bapa</h1><p>Umbo bapa ni umbo lenye pande mbili za urefu na upana tu. Halina unene au kimo. Kuna aina nyingi za maumbo bapa ikiwemo mraba, mstatili, pembetatu, duara na mviringo.</p></div><div class="book-page101-work"><h1><b>Kazi ya kufanya 5:</b> Kuunda maumbo bapa kwa kutumia nukta</h1><p>1. &nbsp; Chunguza kwa makini nukta zifuatazo:</p><img class="book-page101-points-image" src="images/pg107_kazi5_points_transparent.png" alt="Nukta A, B, C na D za kuunda umbo bapa"></div></section>`;
  };
  ...
  const renderPage103 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const shapes=[['pg109_im003_transparent.png','Pembetatu'],['pg109_im002_transparent.png','Mraba'],['pg109_im005_transparent.png','Mstatili'],['pg109_im004_seg001_v1_transparent.png','Duara'],['pg109_im006_transparent.png','Pentagoni'],['pg109_im004_seg002_v1_transparent.png','Heksagoni']];
  ...
  const renderPage104 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const signs=[['pg110_im001_transparent.png','a'],['pg110_im002_transparent.png','b'],['pg110_im003_transparent.png','c'],['pg110_im004_transparent.png','d']];
    content.className='book-page book-page-104 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg110_sec001"><div class="book-page104-work"><h1><b>Kazi ya kufanya 6:</b><span>Kuchora maumbo bapa kwa kutumia TEHAMA<br>(Teknolojia ya Habari na Mawasiliano)</span></h1><ol><li>Bainisha programu yoyote ya kompyuta inayotumika kuchora maumbo bapa.</li><li>Tumia programu uliyoibainisha katika hatua ya 1 kuchora maumbo ya mraba, pembetatu, duara na mstatili.</li><li>Chora maumbo bapa matano tofauti yenye pande tano.</li><li>Chora maumbo mengi zaidi kuimarisha umahiri wako.</li></ol></div><div class="book-example-card book-page104-example"><div class="book-example-label">Mfano</div><p>Chunguza michoro ifuatayo, kisha taja jina la umbo bapa linalohusika:</p><div class="book-page104-signs">${signs.map(([src,l])=>`<figure><figcaption>(${l})</figcaption><img src="images/${src}" alt="Alama ya barabarani ${l}"></figure>`).join('')}</div><h2>Majibu</h2><p>(a) &nbsp; Umbo lina pande nane linaitwa oktagoni.<br>(b) &nbsp; Umbo lina pande nne linaitwa mstatili.<br>(c) &nbsp; Umbo lina pande tatu linaitwa pembetatu.<br>(d) &nbsp; Umbo linaitwa duara.</p></div></section>`;
  };

  const renderPage105 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const files=['pg111_shape_a_clean.png','pg111_shape_b_clean.png','pg111_shape_c_clean.png','pg111_shape_d_clean.png','pg111_shape_e_clean.png','pg111_shape_f_clean.png','pg111_shape_g_clean.png','pg111_shape_h_clean.png','pg111_shape_i_clean.png','pg111_shape_j_clean.png'];
    content.className='book-page book-page-105 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg111_sec001"><div class="book-exercise-sheet book-page105-exercise"><h1 class="book-exercise-title">Zoezi la 4</h1><div class="book-page105-q"><span>1.</span><div><p>Chunguza maumbo bapa a hadi j, kisha jibu maswali yanayofuata.</p><div class="book-page105-shapes">${files.map((f,i)=>`<figure><img src="images/${f}" alt="Umbo ${String.fromCharCode(97+i)}"></figure>`).join('')}</div><p>(a) &nbsp; Chora maumbo yote yenye pembe nne.</p><p>(b) &nbsp; Maumbo mangapi ni pembetatu?</p><p>(c) &nbsp; Taja maumbo ambayo ni duara.</p><p>(d) &nbsp; Tengeneza maumbo yaliyoainishwa kwa herufi a, b, d, e na f kwa kukata karatasi au manila.</p></div></div><div class="book-page105-q"><span>2.</span><div><p>Mchoro ufuatao ni kielelezo cha nyumba iliyotengenezwa kwa maumbo bapa. Chora maumbo bapa yote yaliyopo kwenye mchoro.</p><img class="book-page105-house" src="images/pg111_im001_pdfclean.png" alt="Nyumba iliyotengenezwa kwa maumbo bapa"></div></div></div></section>`;
  };
  ...
  const renderPage113 = () => {
    ...
    const strip12='<div class="book-page113-strip">'+Array.from({length:12}).map(()=>'<span></span>').join('')+'</div>';
    content.className='book-page book-page-113 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg119_sec001"><div class="book-exercise-sheet book-page113-exercise"><div class="book-page113-q"><span>5.</span><div><p>Tia kivuli katika mchoro (a) hadi (e) kuonesha sehemu husika</p><table><tbody>${[3,4,5,6].map((n,i)=>`<tr><td>(${String.fromCharCode(97+i)})</td><td><img src="images/pg119_im00${n}_transparent.png" alt="Mchoro wa sehemu ${fr[i]}"></td><td>${fr[i]}</td></tr>`).join('')}<tr><td>(e)</td><td>${strip12}</td><td>${fr[4]}</td></tr></tbody></table></div></div><div class="book-page113-q"><span>6.</span><div><p>Andika jina la sehemu iliyotiwa kivuli katika michoro (a) hadi (d):</p><div class="book-page113-a"><span>(a)</span><img src="images/pg119_im001_transparent.png" alt="Duara saba, nne zenye kivuli"></div></div></div></section>`;
  };
  ...
  const renderPage114 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg120_sec001"><div class="book-exercise-sheet book-page114-exercise"><div class="book-page114-diagrams">${[1,2,3].map((n,i)=>`<figure><figcaption>(${String.fromCharCode(98+i)})</figcaption><img src="images/pg120_im00${n}_transparent.png" alt="Mchoro wa sehemu ${String.fromCharCode(98+i)}"></figure>`).join('')}</div>${qs.map((q,i)=>`<div class="book-page114-q"><span>${i+7}.</span><p>${q}</p></div>`).join('')}</div></section>`;
  };
  ...
  const renderPage123 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg129_sec001"><div class="book-page123-cont"><p>Hivyo, ¹¹⁄₁₂ − ⁷⁄₁₂ = (11 − 7)/12 = ⁴⁄₁₂.</p><p>Kwa hiyo, ¹¹⁄₁₂ − ⁷⁄₁₂ = ⁴⁄₁₂.</p></div><div class="book-exercise-sheet book-page123-exercise"><h1 class="book-exercise-title">Zoezi la 4</h1><div class="book-page123-sums">${sums.map((x,i)=>`<p><span>${i+1}.</span><span class="expr">${x}</span></p>`).join('')}</div></div></section>`;
  };
  ...
  const renderPage127 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg133_sec001"><div class="book-page127-vocab"><h1>Msamiati</h1><table><tbody>${vocab.map(r=>`<tr><td>${r[0]}</td><td>= ${r[1]}</td><td>${r[2]}</td></tr>`).join('')}</tbody></table></div><div class="book-page127-review"><h1>Zoezi la Marudio</h1><div>${sums.map((x,i)=>`<p><span>${i+1}.</span><span class="expr">${x}</span></p>`).join('')}</div></div></section>`;
  };
  ...
  const renderPage135 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg141_sec001"><div class="book-example-card book-page135-example"><div class="book-example-label">Mfano wa 1</div><p>Chora uso wa saa ya mshale unaoonesha saa 4:00.</p><h2>Hatua</h2><ol style="margin:8px 0 8px!important;padding-left:46px!important">${steps.slice(0,3).map(x=>`<li>${x}</li>`).join('')}</ol><img src="images/pg141_im001_transparent.png" alt="Uso wa saa wenye namba 1 hadi 12"><ol start="4" style="margin:8px 0 8px!important;padding-left:46px!important">${steps.slice(3).map(x=>`<li>${x}</li>`).join('')}</ol><img src="images/pg141_im002_transparent.png" alt="Saa inaonyesha saa nne kamili"><div class="book-page135-last"><span>8.</span><p>Uso wa saa unaonesha saa 4.00.</p></div></div></section>`;
  };
  ...
  const renderPage138 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg144_sec001"><div class="book-page138-cont">${labels.map((label,i)=>`<figure><figcaption>(${label})</figcaption><img src="images/pg144_im00${i+1}_transparent.png${label==='g'?'?clean=148':''}" alt="Saa (${label})"></figure>`).join('')}</div></section>`;
  };
  ...
  const renderPage139 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg145_sec001"><div class="book-page139-answers"><h2>Majibu</h2>${answers.map((x,i)=>`<p><span>(${String.fromCharCode(97+i)})</span>${x}</p>`).join('')}</div><div class="book-exercise-sheet book-page139-exercise"><h1 class="book-exercise-title">Zoezi la 2</h1><div class="book-page139-prompt"><span>1.</span><div><p>Chunguza nyuso za saa zifuatazo, kisha jibu maswali yafuatayo:</p><div class="book-page139-clocks"><figure><figcaption>A</figcaption><img src="images/pg145_im001_pdfclean.png?v=page139-full-clock" alt="Saa A"></figure><figure><figcaption>B</figcaption><img src="images/pg145_im002_transparent.png?v=page139-clean" alt="Saa B"></figure></div>${questions.map((q,i)=>`<p>(${String.fromCharCode(97+i)})&nbsp; ${q}</p>`).join('')}</div></div></div></section>`;
  };
  ...
  const renderPage140 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg146_sec001"><div class="book-exercise-sheet book-page140-exercise"><div class="book-page140-prompt"><span>2.</span><p>Soma saa zifuatazo, kisha andika muda kwa numerali na kwa maneno.</p></div><div class="book-page140-clocks">${labels.map((label,i)=>`<figure><figcaption>(${label})</figcaption><img src="images/pg146_clock${i+1}_pdf.png?v=page140-clean" alt="Saa (${label})"></figure>`).join('')}</div></div></section>`;
  };
  ...
  const renderPage141 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg147_sec001"><div class="book-exercise-sheet book-page141-exercise"><div class="book-page141-prompt"><span>3.</span><p>Chora mishale katika nyuso za saa kuonesha muda uliotajwa.</p></div><div class="book-page141-clocks">${clocks.map(([l,t])=>`<figure><figcaption>(${l})</figcaption><img src="images/pg147_blank_clock_pdf.png?v=page141-clean" alt="Uso wa saa usio na mishale"><p>${t}</p></figure>`).join('')}</div><div class="book-page141-q4"><span>4.</span><div><p>Andika muda kwa maneno.</p>${times.map((t,i)=>`<p><span>(${String.fromCharCode(97+i)})</span><b>${t}</b><i></i></p>`).join('')}</div></div></div></section>`;
  };
  ...
  const renderPage148 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const holidays=[['Jan 1','Mwaka mpya'],['Jan 12','Mapinduzi ya Zanzibar'],['Apr 7','Kumbukumbu ya Karume'],['Apr 19','Ijumaa Kuu'],['Apr 21','Jumapili ya Pasaka'],['Apr 22','Jumatatu ya Pasaka'],['Aprili 26','Siku ya Muungano'],['Mei 1','Siku ya wafanyakazi'],['Jun 4','Sikukuu ya Idi'],['Jul 7','Saba Saba'],['Agosti 8','Siku ya Wakulima'],['Agosti 11','Sikukuu ya Idi'],['Okt 14','Kumbukumbu ya Mwalimu Nyerere'],['Nov 9','Sikukuu ya Maulid'],['Des 9','Siku ya Uhuru'],['Des 25','Sikukuu ya Krismasi'],['Des 26','Siku ya kufungua zawadi']];
    const months=['JANUARI','FEBRUARI','MACHI','APRILI','MEI','JUNI','JULAI','AGOSTI','SEPTEMBA','OKTOBA','NOVEMBA','DESEMBA'];
    const special={0:[1,12],3:[7,19,21,22,26],4:[1],5:[4],6:[7],7:[8,11],9:[14],10:[9],11:[9,25,26]};
    const monthTable=(month)=>{
      const first=new Date(2019,month,1).getDay();
      const days=new Date(2019,month+1,0).getDate();
      const cells=[];
      for(let i=0;i<first;i++) cells.push('<span class="is-empty" aria-hidden="true"></span>');
      for(let day=1;day<=days;day++){
        const marked=(special[month]||[]).includes(day);
        cells.push(`<span${marked?' class="is-special"':''}>${day}</span>`);
      }
      return `<section class="book-calendar-month" aria-label="${months[month]} 2019"><h3>${months[month]}</h3><div class="book-calendar-weekdays" aria-hidden="true"><b>S</b><b>M</b><b>T</b><b>W</b><b>T</b><b>F</b><b>S</b></div><div class="book-calendar-days">${cells.join('')}</div></section>`;
    };
    const holidayTable=(year,rows)=>`<div class="book-holiday-table"><h2>Sikukuu za Tanzania - ${year}</h2><div>${[rows.slice(0,Math.ceil(rows.length/2)),rows.slice(Math.ceil(rows.length/2))].map(group=>`<table><tbody>${group.map(r=>`<tr><td>${r[0]}</td><td>${r[1]}</td></tr>`).join('')}</tbody></table>`).join('')}</div></div>`;
    content.className='book-page book-page-148 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg154_sec001"><div class="book-page148-copy"><p>Zifuatazo ni kalenda za mwaka 2019 na mwaka 2020.</p><div class="book-page148-calendar" aria-label="Kalenda ya Tanzania ya mwaka 2019"><div class="book-page148-calendar-heading"><strong>2019</strong><span>Tanzania</span></div><div class="book-page148-calendar-months">${months.map((_,month)=>monthTable(month)).join('')}</div></div>${holidayTable(2019,holidays)}</div></section>`;
  };

  const renderPage149 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const holidays=[['Jan 1','Mwaka mpya'],['Jan 12','Mapinduzi ya Zanzibar'],['Apr 7','Kumbukumbu ya Karume'],['Apr 10','Ijumaa Kuu'],['Apr 12','Jumapili ya Pasaka'],['Apr 13','Jumatatu ya Pasaka'],['Aprili 26','Siku ya Muungano'],['Mei 1','Siku ya wafanyakazi'],['Mei 24','Sikukuu ya Idi'],['Jul 7','Saba Saba'],['Jul 31','Sikukuu ya Idi'],['Agosti 8','Siku ya Wakulima'],['Okt 14','Kumbukumbu ya Mwalimu Nyerere'],['Okt 29','Sikukuu ya Maulid'],['Des 9','Siku ya Uhuru'],['Des 25','Sikukuu ya Krismasi'],['Des 26','Siku ya kufungua zawadi']];
    const months=['JANUARI','FEBRUARI','MACHI','APRILI','MEI','JUNI','JULAI','AGOSTI','SEPTEMBA','OKTOBA','NOVEMBA','DESEMBA'];
    const special={0:[1,12],3:[7,10,12,13,26],4:[1,24],6:[7,31],7:[8],9:[14,29],11:[9,25,26]};
    const monthTable=(month)=>{
      const first=new Date(2020,month,1).getDay();
      const days=new Date(2020,month+1,0).getDate();
      const cells=[];
      for(let i=0;i<first;i++) cells.push('<span class="is-empty" aria-hidden="true"></span>');
      for(let day=1;day<=days;day++){
        const marked=(special[month]||[]).includes(day);
      ...
      return `<section class="book-calendar-month" aria-label="${months[month]} 2020"><h3>${months[month]}</h3><div class="book-calendar-weekdays" aria-hidden="true"><b>S</b><b>M</b><b>T</b><b>W</b><b>T</b><b>F</b><b>S</b></div><div class="book-calendar-days">${cells.join('')}</div></section>`;
    };
    const split=Math.ceil(holidays.length/2);
    content.className='book-page book-page-149 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg155_sec001"><div class="book-page149-copy"><div class="book-page148-calendar book-page149-calendar" aria-label="Kalenda ya Tanzania ya mwaka 2020"><div class="book-page148-calendar-heading"><strong>2020</strong><span>Tanzania</span></div><div class="book-page148-calendar-months">${months.map((_,month)=>monthTable(month)).join('')}</div></div><div class="book-holiday-table"><h2>Sikukuu za Tanzania - 2020</h2><div>${[holidays.slice(0,split),holidays.slice(split)].map(group=>`<table><tbody>${group.map(r=>`<tr><td>${r[0]}</td><td>${r[1]}</td></tr>`).join('')}</tbody></table>`).join('')}</div></div></div></section>`;
  };
  ...
  const renderPage151 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg157_sec001"><div class="book-page151-review"><h1>Zoezi la marudio</h1><div class="book-page151-q"><span>1.</span><div><p>Chora nyuso za saa ya mshale kuonesha muda ufuatao:</p>${['Saa sita na robo (6:15)','Saa kumi kamili (10:00)','Saa mbili na nusu (2:30)','Saa tatu na dakika arobaini na tano (3:45)'].map((x,i)=>`<p><span>(${String.fromCharCode(97+i)})</span>${x}</p>`).join('')}</div></div><div class="book-page151-q"><span>2.</span><div><p>Andika muda ufuatao kwa maneno:</p>${times.map((x,i)=>`<p class="book-page151-line"><span>(${String.fromCharCode(97+i)})</span><span class="book-page151-time">${x}</span><i></i></p>`).join('')}</div></div><div class="book-page151-q"><span>3.</span><div><p>Chagua maneno kutoka orodha B na yaandike katika orodha A ili yalete maana sahihi:</p><table><thead><tr><th>Orodha A</th><th>Orodha B</th></tr></thead><tbody>${Array.from({length:8},(_,i)=>`<tr><td>${a[i]?`(${String.fromCharCode(97+i)}) &nbsp; ${a[i]}`:''}</td><td>${b[i]}</td></tr>`).join('')}</tbody></table></div></div></div></section>`;
  };
  ...
  const renderPage154 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg160_sec001">${examples.map(([n,q,a])=>`<div class="book-example-card book-page154-example"><div class="book-example-label">Mfano wa ${n}</div><p>${q}</p><h2>Jibu</h2><p>${a}</p></div>`).join('')}<div class="book-exercise-sheet book-page154-exercise"><h1 class="book-exercise-title">Zoezi la 1</h1><p>Chunguza sarafu za Tanzania, kisha jibu maswali yanayofuata.</p>${pairs.map(([a,b,l])=>`<figure><figcaption>(${l})</figcaption><div><img src="images/pg160_im00${a}_transparent.png" alt="Sarafu upande wa kwanza"><img src="images/pg160_im00${b}_transparent.png" alt="Sarafu upande wa pili"></div><p>Shilingi <i></i></p></figure>`).join('')}</div></section>`;
  };
  ...
  const renderPage162 = () => {
    ...
    const money=(rows,result='')=>{
      const hasCents=rows.some(([,st])=>st !== '');
      if(!hasCents) return `<div class="book-page162-stack no-cents">${rows.map(([sh,,op=''])=>`<span>${op || 'sh '}${sh}</span>`).join('')}<i></i>${result?`<span class="result">sh ${result.split('|')[0]}</span><i></i>`:'<i></i>'}</div>`;
      return `<div class="book-page162-stack"><span>sh</span><span>st</span>${rows.map(([sh,st,op=''])=>`<span>${op}${sh}</span><span>${st}</span>`).join('')}<i></i>${result?`<span class="result">${result.split('|')[0]}</span><span class="result">${result.split('|')[1]||''}</span><i></i>`:'<i></i>'}</div>`;
    };
    content.innerHTML=`<section data-section-id="pg168_sec001"><div class="book-example-card book-page162-example"><div class="book-example-label">Mfano wa 2</div>${money([['4596','65'],['3987','75','+ ']])}<h2>Hatua</h2><div class="book-page162-steps"><div><span>1.</span><p>Jumlisha senti: &nbsp;65 + 75 = st 140<br>Badili st 140 kuwa sh 1 na st 40. Kisha andika st 40 katika nafasi ya senti na jumlisha sh 1 katika shilingi</p>${money([['4596','65'],['3987','75','+ ']],'|40')}</div><div><span>2.</span><p>Jumlisha shilingi:<br>1 + 4596 + 3987 = 8584.<br>Andika sh 8584 katika nafasi ya shilingi</p>${money([['4596','65'],['3987','75','+ ']],'8584|40')}</div></div><p>Kwa hiyo, jibu ni sh 8,584 st 40.</p></div><div class="book-example-card book-page162-example second"><div class="book-example-label">Mfano wa 3</div>${money([['11650',''],['78450','','+ sh ']])}<h2>Njia</h2>${money([['11650',''],['78450','','+ sh ']],'90100|')}<p>Kwa hiyo, jibu ni sh 90,100.</p></div></section>`;
  };

  const renderPage163 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const inline=['sh 5000 + sh 4000 =','sh 2438 + sh 4326 =','sh 1326 + sh 1318 =','sh 625445 st 50 + sh 357223 st 85 =','sh 14955 st 50 + sh 4955 st 55 =','sh 423293 st 45 + sh 549314 st 45 ='];
    const vertical=[
      ['4521','','2183',''],['1326','','2788',''],['625','45','364','20'],
      ['5001','80','4999','45'],['1060','05','2175','15'],['714370','80','3056','35'],
      ['433270','55','433865','45'],['385534','05','453057','45'],['60250','','28970','']
    ];
    const stack=([a,ast,b,bst],number)=>`<div class="book-page163-vertical"><span class="number">${number}.</span><div class="sum ${ast||bst?'money':''}">${ast||bst?'<b>sh</b><b>st</b>':''}<span>${ast||bst?'': 'sh '}${a}</span>${ast||bst?`<span>${ast}</span>`:''}<span>+ ${ast||bst?'':'sh '}${b}</span>${ast||bst?`<span>${bst}</span>`:''}<i></i><i></i></div></div>`;
    content.className='book-page book-page-163 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg169_sec001"><div class="book-exercise-sheet book-page163-exercise"><h1 class="book-exercise-title">Zoezi la 5</h1><div class="book-page163-inline">${inline.map((x,i)=>`<div><span>${i+1}.</span><p>${x}</p></div>`).join('')}</div><div class="book-page163-sums">${vertical.map((x,i)=>stack(x,i+7)).join('')}</div></div></section>`;
  };
  ...
  const renderPage166 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const stack=(result='')=>`<div class="book-page166-stack"><span>sh</span><span>st</span><span>83721</span><span>85</span><span>− 61510</span><span>40</span><i></i>${result?`<span></span><span class="result">${result}</span><i></i>`:'<i></i>'}</div>`;
    content.className='book-page book-page-166 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg172_sec001"><div class="book-page166-cont"><span>10.</span><p>Juhudi alipata zawadi ya shilingi 52,500 baada ya kufaulu mtihani wa Hisabati. Pia, mama yake alimpatia shilingi 21,700. Iwapo Juhudi alikuwa na shilingi 18,550 kabla ya zawadi, je, jumla alikuwa na kiasi gani cha fedha?</p></div><div class="book-page166-copy"><h1>Kutoa fedha</h1><p>Tendo la kutoa fedha hufanyika kama kutoa namba nzima kwa kuanzia kulia kwenda kushoto.</p></div><div class="book-example-card book-page166-example"><div class="book-example-label">Mfano wa 1</div><p>sh 48 965 st 95 − sh 25 843 st 85 =</p><h2>Hatua</h2><ol><li>Toa senti: 95 − 85 = st 10. Andika senti katika nafasi ya senti</li><li>Toa shilingi: 48 965 − 25 843 = sh 23 122. Andika shilingi katika nafasi ya shilingi.</li></ol><p>Kwa hiyo, jibu ni sh 23 122 st 10.</p></div><div class="book-example-card book-page166-example second"><div class="book-example-label">Mfano wa 2</div>${stack()}<h2>Hatua</h2><div class="book-page166-step"><div><p>Toa senti: 85 − 40 = st 45</p><p>Andika st 45 katika nafasi ya senti</p></div>${stack('45')}</div></div></section>`;
  };

  const renderPage167 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const stack=(resultSh='',resultSt='')=>`<div class="book-page167-stack"><span>sh</span><span>st</span><span>869335</span><span>30</span><span>− 427123</span><span>70</span><i></i>${resultSh||resultSt?`<span class="result">${resultSh}</span><span class="result">${resultSt}</span><i></i>`:'<i></i>'}</div>`;
    content.className='book-page book-page-167 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg173_sec001"><div class="book-example-card book-page167-cont"><div><p>Toa shilingi:</p><p>83721 − 61510 = sh 22211</p><p>Andika sh 22211 katika nafasi ya shilingi</p><p>Kwa hiyo, jibu ni sh 22211 st 45.</p></div><div class="book-page167-stack continuation"><span>sh</span><span>st</span><span>83721</span><span>85</span><span>− 61510</span><span>40</span><i></i><span class="result">22211</span><span class="result">45</span><i></i></div></div><div class="book-example-card book-page167-example"><div class="book-example-label">Mfano wa 3</div>${stack()}<h2>Hatua</h2><div class="book-page167-steps"><div class="book-page167-step"><span>1.</span><p>Toa senti: &nbsp;30 − 70 haitoshelezi.<br>Chukua shilingi moja kutoka katika<br>shilingi 5 badili kuwa na st 100.<br>Jumlisha senti: &nbsp;100 + 30 = st 130.<br>Toa senti: &nbsp;130 − 70 = st 60<br>Andika st 60 katika nafasi ya senti<br>Kumbuka umechukua shilingi 1 kwenye shilingi 5.<br>Hivyo, umebakiwa na shilingi 4.</p>${stack('', '60')}</div><div class="book-page167-step"><span>2.</span><p>Toa shilingi:<br>869334 − 427123 = sh 442211<br>Andika sh 442211 katika nafasi<br>ya shilingi</p>${stack('442211', '60')}</div></div><p class="book-page167-answer">Kwa hiyo, jibu ni sh 442,211 st 60.</p></div></section>`;
  };
  ...
  const renderPage168 = () => {
    ...
    const stack=(result='')=>`<div class="book-page168-stack"><span>sh &nbsp;4180</span><span>− &nbsp;sh &nbsp;2494</span><i></i>${result?`<span class="result">sh &nbsp;${result}</span><i></i>`:'<i></i>'}</div>`;
    content.className='book-page book-page-168 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg174_sec001"><div class="book-example-card book-page168-example"><div class="book-example-label">Mfano wa 4</div>${stack()}<h2>Njia</h2>${stack('1686')}<p>Kwa hiyo, jibu ni sh 1,686.</p></div><div class="book-exercise-sheet book-page168-exercise"><h1 class="book-exercise-title">Zoezi la 7</h1>${sums.map((q,i)=>`<div><span>${i+1}.</span><p>${q}</p></div>`).join('')}</div></section>`;
  };

  const renderPage169 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const sums=[['4330','','1215',''],['6779','','4125',''],['80560','','60590',''],['99100','','65700',''],['75750','','25920',''],['35000','','20090',''],['21800','','15350',''],['42300','','18800',''],['720561','65','310340','40'],['564868','25','19853','75']];
    const stack=([a,ast,b,bst],number)=>`<div class="book-page169-problem"><span class="number">${number}.</span><div class="book-page169-stack ${ast||bst?'money':''}">${ast||bst?'<b>sh</b><b>st</b>':''}<span>${ast||bst?'':'sh &nbsp;'}${a}</span>${ast||bst?`<span>${ast}</span>`:''}<span>− &nbsp;${ast||bst?'':'sh &nbsp;'}${b}</span>${ast||bst?`<span>${bst}</span>`:''}<i></i><i></i></div></div>`;
    content.className='book-page book-page-169 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg175_sec001"><div class="book-exercise-sheet book-page169-exercise"><div class="book-page169-sums">${sums.map((r,i)=>stack(r,i+9)).join('')}</div></div></section>`;
  };

  const renderPage170 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const sums=[['867662','20','453221','10'],['954330','30','623220','10'],['212011','10','11102','60'],['68654','14','18129','14'],['4500','80','180','45'],['100','10','90','20'],['945601','70','431102','60']];
    const stack=([a,ast,b,bst],number)=>`<div class="book-page170-problem"><span class="number">${number}.</span><div class="book-page170-stack"><b>sh</b><b>st</b><span>${a}</span><span>${ast}</span><span>− &nbsp;${b}</span><span>${bst}</span><i></i><i></i></div></div>`;
    content.className='book-page book-page-170 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg176_sec001"><div class="book-exercise-sheet book-page170-exercise"><div class="book-page170-sums">${sums.map((r,i)=>stack(r,i+19)).join('')}</div></div></section>`;
  };

  const renderPage171 = () => {
    const content=document.querySelector('#content');if(!content)return;
    content.className='book-page book-page-171 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg177_sec001"><h1 class="book-page171-title">Mafumbo yenye dhana ya kutoa fedha ya Tanzania</h1><div class="book-example-card book-page171-example first"><div class="book-example-label">Mfano wa 1</div><p>Anna alikuwa na shilingi 80,800. Alitumia shilingi 20,000 kununua sare za shule na shilingi 17,500 kununua madaftari. Je, Anna alibakiwa na kiasi gani cha fedha?</p><h2>Njia</h2><div class="book-page171-labeled-sum"><span>Sare za shule:</span><b>sh &nbsp;20000</b><span>Madaftari:</span><b>+ &nbsp;sh &nbsp;17500</b><i></i><span></span><b>sh &nbsp;37500</b><i></i></div><p>Anna alitumia jumla ya shilingi 37,500 kununulia sare za shule na madaftari.</p><p>Chukua kiasi alichokuwa nacho, toa kiasi alichotumia.</p><div class="book-page171-labeled-sum second"><span>Kiasi alichokuwa nacho:</span><b>sh 80800</b><span>Jumla aliyotumia:</span><b>− &nbsp;sh 37500</b><i></i><span></span><b>sh 43300</b><i></i></div><p>Kwa hiyo, Anna alibakiwa na shilingi 43,300.</p></div><div class="book-example-card book-page171-example second-card"><div class="book-example-label">Mfano wa 2</div><p>Petro aliuza ng’ombe mmoja kwa shilingi 450,000 siku ya mnada. Baada ya mnada alimpa mtoto wake kiasi cha shilingi 215,000 kwa ajili ya mahitaji ya shule. Je, Petro alibakiwa na kiasi gani?</p><h2>Njia</h2><div class="book-page171-labeled-sum compact"><span>Bei ya ng’ombe:</span><b>sh 450000</b><span>Kiasi alichotoa:</span><b>− &nbsp;sh 215000</b><i></i><span></span><b>sh 235000</b><i></i></div><p>Petro alibakiwa na sh 235,000.</p></div></section>`;
  };
  ...
  const renderPage174 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg180_sec001"><div class="book-page174-review"><h1>Zoezi la Marudio</h1><p>Chunguza noti zifuatazo, kisha jibu swali la 1 hadi 3.</p><figure><figcaption>(a)</figcaption><span class="book-note-example"><img src="images/pg180_im001.jpg" alt="Noti ya shilingi elfu tano upande wa mbele"><b style="font-size:72px!important;line-height:1!important">Mfano</b></span><span class="book-note-example"><img src="images/pg180_im002.jpg" alt="Noti ya shilingi elfu tano upande wa nyuma"><b style="font-size:72px!important;line-height:1!important">Mfano</b></span></figure><figure><figcaption>(b)</figcaption><span class="book-note-example"><img src="images/pg180_im003.jpg" alt="Noti ya shilingi elfu kumi upande wa mbele"><b style="font-size:72px!important;line-height:1!important">Mfano</b></span></figure></div></section>`;
  };
  ...
  const renderPage175 = () => {
    ...
    content.innerHTML=`<section data-section-id="pg181_sec001"><div class="book-page175-review"><span class="book-note-example"><img src="images/pg181_im001.jpg" alt="Noti ya shilingi elfu kumi upande wa nyuma"><b style="font-size:72px!important;line-height:1!important">Mfano</b></span><div class="book-page175-q"><span>1.</span><p>Taja majina ya noti (a) na (b).</p></div><div class="book-page175-q"><span>2.</span><p>Taja alama tatu zilizopo katika noti (a)</p></div><div class="book-page175-q"><span>3.</span><p>Taja alama tatu zilizopo katika noti (b)</p></div><div class="book-page175-q"><span>4.</span><div><p>Andika kiasi cha fedha zifuatazo kwa kifupi:</p><table><thead><tr><th>Fedha kwa maneno</th><th>Fedha kwa kifupi</th></tr></thead><tbody><tr><td>(a) Shilingi elfu moja mia moja na senti ishirini</td><td></td></tr><tr><td>(b) Shilingi mia sita arobaini na senti tano</td><td></td></tr></tbody></table></div></div>${sums.map((q,i)=>`<div class="book-page175-q"><span>${i+5}.</span><p>${q}</p></div>`).join('')}</div></section>`;
  };
  ...
  const renderPage176 = () => {
    ...
    const stacks=[['6430','','5240',''],['9883','','3265',''],['90527','85','30210','80'],['71171','00','15101','50'],['67501','70','35322','35'],['868660','45','534330','15']];
    const stack=([a,ast,b,bst],number)=>`<div class="book-page176-problem"><span class="number">${number}.</span><div class="book-page176-stack ${ast||bst?'money':''}">${ast||bst?'<b>sh</b><b>st</b>':''}<span>${ast||bst?'':'sh &nbsp;'}${a}</span>${ast||bst?`<span>${ast}</span>`:''}<span>− &nbsp;${ast||bst?'':'sh &nbsp;'}${b}</span>${ast||bst?`<span>${bst}</span>`:''}<i></i><i></i></div></div>`;
    content.className='book-page book-page-176 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg182_sec001"><div class="book-page176-review">${text.map((q,i)=>`<div class="book-page176-line"><span>${i+12}.</span><p>${q}</p></div>`).join('')}<div class="book-page176-stacks">${stacks.map((r,i)=>stack(r,i+21)).join('')}</div></div></section>`;
  };

  const renderPage177 = () => {
    const content=document.querySelector('#content');if(!content)return;
    const stacks=[['+','27800','','39400',''],['+','156280','15','138270','30'],['+','70880','','16970',''],['+','178850','45','235112','55'],['+','5075','05','3350','50'],['−','263009','65','124087','55']];
    ...
    const stack=([op,a,ast,b,bst],number)=>`<div class="book-page177-problem"><span class="number">${number}.</span><div class="book-page177-stack ${ast||bst?'money':''}">${ast||bst?'<b>sh</b><b>st</b>':''}<span>${ast||bst?'':'sh &nbsp;'}${a}</span>${ast||bst?`<span>${ast}</span>`:''}<span>${op} &nbsp;${ast||bst?'':'sh &nbsp;'}${b}</span>${ast||bst?`<span>${bst}</span>`:''}<i></i><i></i></div></div>`;
    content.className='book-page book-page-177 book-after-page15 book-after-page18 opacity-100 visible';
    content.innerHTML=`<section data-section-id="pg183_sec001"><div class="book-page177-review"><div class="book-page177-stacks">${stacks.map((r,i)=>stack(r,i+27)).join('')}</div>${qs.map((q,i)=>`<div class="book-page177-q"><span>${i+33}.</span><p>${q}</p></div>`).join('')}</div></section>`;
  };
  ...
  // Printed page 101 begins at physical page 107.  Keep its shared spacing
  // refinements scoped to this portion of the book so earlier approved pages
  // retain their established layout.
  const lateBookRoot=document.querySelector('#content');
  if (lateBookRoot && page >= 107) lateBookRoot.classList.add('book-print-page101-plus');

  // Fractions in the source use a full-height stacked notation. Normalize the
  // assorted Unicode and slash forms emitted by the conversion so every
  // fraction keeps the same visual size as the surrounding book text.
  if (page >= 116 && page <= 136) {
    const root=document.querySelector('#content');
    const supMap={'⁰':'0','¹':'1','²':'2','³':'3','⁴':'4','⁵':'5','⁶':'6','⁷':'7','⁸':'8','⁹':'9'};
    const subMap={'₀':'0','₁':'1','₂':'2','₃':'3','₄':'4','₅':'5','₆':'6','₇':'7','₈':'8','₉':'9'};
    const vulgar={'½':['1','2'],'⅓':['1','3'],'⅔':['2','3'],'¼':['1','4'],'¾':['3','4'],'⅕':['1','5'],'⅖':['2','5'],'⅗':['3','5'],'⅘':['4','5'],'⅙':['1','6'],'⅚':['5','6'],'⅛':['1','8'],'⅜':['3','8'],'⅝':['5','8'],'⅞':['7','8'],'⅐':['1','7'],'⅑':['1','9']};
    const fraction=(top,bottom)=>{
      const span=document.createElement('span');
      span.className='book-fraction';
      span.innerHTML=`<span>${top}</span><span>${bottom}</span>`;
      return span;
    };
    const nodes=[];
    ...
    while(walker.nextNode()){
      ...
      if(n.parentElement?.closest('script,style,.book-fraction'))continue;
      if(/[½⅓⅔¼¾⅕⅖⅗⅘⅙⅚⅛⅜⅝⅞⅐⅑⁄]|\([^()]+\)\/\d+|\b\d+\/\d+\b/.test(n.textContent))nodes.push(n);
    }
    nodes.forEach((node)=>{
      const re=/([⁰¹²³⁴⁵⁶⁷⁸⁹]+)⁄([₀₁₂₃₄₅₆₇₈₉]+)|\(([^()]+)\)\/(\d+)|\b(\d+)\/(\d+)\b|[½⅓⅔¼¾⅕⅖⅗⅘⅙⅚⅛⅜⅝⅞⅐⅑]/g;
      const frag=document.createDocumentFragment();let last=0;let m;
      while((m=re.exec(node.textContent))){
        frag.append(document.createTextNode(node.textContent.slice(last,m.index)));
        let top,bottom;
        if(vulgar[m[0]])[top,bottom]=vulgar[m[0]];
        else if(m[1]){top=[...m[1]].map(x=>supMap[x]).join('');bottom=[...m[2]].map(x=>subMap[x]).join('');}
        else if(m[3]){top=m[3];bottom=m[4];}
        else {top=m[5];bottom=m[6];}
        frag.append(fraction(top,bottom));last=re.lastIndex;
      }
      frag.append(document.createTextNode(node.textContent.slice(last)));
  ...
  // The book font omits several Unicode arithmetic glyphs in browsers. Keep
  // the surrounding typography, but give every operator from source page 66
  // onward a reliable glyph font after the page-specific renderer completes.
  if (page >= 72) {
    const root=document.querySelector('#content');
    root.classList.add('book-from-page66');
    if(page>=90)root.classList.add('book-from-print-page84');
    const textNodes=[];
    [root, ...root.querySelectorAll('*')].forEach((parent)=>{
      if(parent.closest?.('.book-arithmetic-symbol, script, style'))return;
      [...parent.childNodes].forEach((node)=>{
        if(node.nodeType===3 && /[−–×÷+=≤≥]|(?:\s-\s)/.test(node.textContent))textNodes.push(node);
      });
    });
